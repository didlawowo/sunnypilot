...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  # ioniq-control (#157) — bandeau masqué : le clignotant sert aussi à tourner.
  # Entrées VIDÉES, jamais supprimées : create_alerts indexe EVENTS[e] en direct
  # et event_counters est bâti sur EVENTS.keys() — retirer la clé ferait lever un
  # KeyError dans selfdrived au premier clignotant.
  # Le comportement ne change pas : le changement de voie reste conditionné au
  # couple volant (desire_helper). laneChangeBlocked est conservé, lui.
